...
const Login = () => {
  ...
  const handleSubmit = async e =>{
    ...
    try {
      ...
      localStorage.setItem('Task session' , data.token)
      setAuth(data)
  ...
  return (
    <>
      <div className="flex mt-5">
        ...
        <div>
          <h1 className="font-bold text-4xl mt-5">¡Inicia sesión y administra  {" "}
          <span className="text-slate-400">tus Archivos!</span></h1>
        </div>
      </div>
