...
const ModalEliminarColaborador = () => {
    const {handleModalEliminarColaborador,modalEliminarColaborador,eliminarColaborador,colaborador} = useProyectos()
    return (
                ...
                <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                <button
                                    type="button"
                                    className="bg-white rounded-md text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 transition duration-300 focus:ring-red-200"
                            ...
                            <div className="sm:flex sm:items-start">                                     
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-800 uppercase">Si eliminas al colaborador , no se podrá recuperar</p>
                                    </div>
